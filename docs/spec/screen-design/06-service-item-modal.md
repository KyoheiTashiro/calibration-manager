...
**目的**: 点検校正項目(ServiceItem)の新規登録・編集。機器詳細・点検校正項目一覧から起動。

**起動元**: [機器詳細](./04-equipment-detail.md)、[点検校正項目一覧](./05-service-item-list.md)
...
| 周期         | cycle            | ○       | enum(1M/3M/6M/1Y/2Y/3Y/5Y/10Y)。表示は日本語(1ヶ月/1年等) |
